...
class GUI(object):
    ...
    def est_callback_1(self, msg):
        self.robot_pose_est_1 = msg
	...
	ptx=[self.robot_pose_est_1.x]
        pty=[self.robot_pose_est_1.y]
        self._ax1.scatter(ptx, pty, c='y', s = 64);
        ptx=[self.robot_pose_est_1.x+0.2*math.cos(self.robot_pose_est_1.theta)]
        pty=[self.robot_pose_est_1.y+0.2*math.sin(self.robot_pose_est_1.theta)]
        self._ax1.scatter(ptx, pty, c='y', s = 16);
